...
public class sa_sa_screen extends AppCompatActivity {
    private static final String TAG = "sa_sa_screen";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sa_sa_screen);
    ...
    private void question(int counter) {
        switch (counter) {
            ...
            case 1:
                text.setText("Ma");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_ma);
                break;
            case 2:
            case 3:
                text.setText("Sa");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_sa);
                break;
            case 4:
                text.setText("Asa");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_asa);
                break;
            case 5:
                text.setText("Masa");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_masa);
                break;
            case 6:
                text.setText("Masama");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_masama);
                break;
            case 7:
                text.setText("Usa");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_usa);
                break;
            case 8:
                text.setText("Sama");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_sama);
                break;
            case 9:
                text.setText("Sasama");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_sasama);
                break;
            case 10:
                text.setText("Isa");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_isa);
                break;
            case 11:
                text.setText("Isama");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_isama);
                break;
            case 12:
                text.setText("Isasama");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_isasama);
                break;
            case 13:
                text.setText("Masama ang ama");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_masama_ang_ama);
                break;
            case 14:
                text.setText("Sasama ang masa sa usa");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_sasama_ang_masa_sa_usa);
                break;
            case 15:
                text.setText("Kay Isa ang usa");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_kay_isa_ang_usa);
                break;
            case 16:
                text.setText("Ang Usa");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_ang_usa);
                break;
            case 17:
                text.setText("May usa si Isa");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_may_usa_si_isa);
                break;
            case 18:
                text.setText("Iisa ang usa");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_iisa_ang_usa);
                break;
            case 19:
                text.setText("Sasama ang usa sa ama");
                sound = MediaPlayer.create(sa_sa_screen.this, R.raw.new_sasama_ang_usa_sa_ama);
                break;
        }
    }
    ...
    private void say_question(final int counter) {
        ...
        sound = MediaPlayer.create(sa_sa_screen.this, R.raw.ba);
        sound.release();
        sound = MediaPlayer.create(sa_sa_screen.this, R.raw.makinig_at_basahin_ng_mabuti_ang_mga_titik_gamit_ang_mikropono);
        sound.start();
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int i) {
                ...
                if (bool_mic_case_down) {
                    bool_mic_case_down = false;
                    sound_mali = MediaPlayer.create(sa_sa_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                } else {
                    if (i == 1 || i == 2 || i == 3 || i == 4) {
                        sound_mali = MediaPlayer.create(sa_sa_screen.this, R.raw.kailangan_kumunekta_sa_internet1);
                    } else if (i == 6) {
                        sound_mali = MediaPlayer.create(sa_sa_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                    } else if (i == 7 || i == 5 || i == 9) {
                        sound_mali = speak_tama.speak_mali(sa_sa_screen.this);
                    } else {
                        sound_mali = MediaPlayer.create(sa_sa_screen.this, R.raw.pakiulit_ng_iyong_sinabi1);
                    }
                }
            ...
            public void onResults(Bundle bundle) {
                ...
                if (speech_method.speech(text_text, speech)) {
                    sound = speak_tama.speak_tama(sa_sa_screen.this);
                    counter++;
                    tama = true;
                    ...
                    sound.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            ...
                            if (counter == 20) {
                                ...
                                Intent go = new Intent(sa_sa_screen.this, overview_screen.class);
                                go.putExtra("SIMULA", simula)
                                        .putExtra("WAKAS", wakas)
                                        .putExtra("ORAS", oras)
                                        .putExtra("DATE", date_t)
                                        .putExtra("TITLE", "Marungko Approach: Sa-sa");
                                startActivity(go);
                                Animatoo.animateShrink(sa_sa_screen.this);
                                finish();
                            } else {
                                check.setVisibility(View.INVISIBLE);
                                question(counter);
    ...
    private void initialise() {
        ...
        if (bgm == null) {
            bgm = MediaPlayer.create(sa_sa_screen.this, R.raw.bgm1);
            bgm.setVolume(.1f, .1f);
            bgm.setLooping(true);
            bgm.start();
        }
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                speak_tama.tap_back(sa_sa_screen.this);
                startActivity(new Intent(sa_sa_screen.this, CategoryScreen.class));
                Animatoo.animateSlideRight(sa_sa_screen.this);
                finish();
            }
        });
    ...
    private void checkPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (!(ContextCompat.checkSelfPermission(sa_sa_screen.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED)) {
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Sige", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ActivityCompat.requestPermissions(sa_sa_screen.this, new String[]{Manifest.permission.RECORD_AUDIO}, REQUEST_PERMISSION_RECORD_AUDIO);
                                }
                            })
