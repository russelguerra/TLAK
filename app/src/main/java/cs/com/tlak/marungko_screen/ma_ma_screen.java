...
public class ma_ma_screen extends AppCompatActivity {
    private static final String TAG = "ma_ma_screen";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ma_ma_screen);
    ...
    private void question(int counter) {
        switch (counter) {
            ...
            case 1:
                text.setText("Ma");
                sound = MediaPlayer.create(ma_ma_screen.this, R.raw.new_ma);
                break;
            case 4:
                text.setText("Ama");
                sound = MediaPlayer.create(ma_ma_screen.this, R.raw.new_ama);
                break;
            case 5:
                text.setText("Ima");
                sound = MediaPlayer.create(ma_ma_screen.this, R.raw.new_ima);
                break;
            case 6:
                text.setText("Uma");
                sound = MediaPlayer.create(ma_ma_screen.this, R.raw.new_uma);
                break;
            case 7:
                text.setText("Ema");
                sound = MediaPlayer.create(ma_ma_screen.this, R.raw.new_ema);
                break;
            case 8:
                text.setText("Oma");
                sound = MediaPlayer.create(ma_ma_screen.this, R.raw.new_oma);
                break;
            case 9:
                text.setText("Mama");
                sound = MediaPlayer.create(ma_ma_screen.this, R.raw.new_mama);
                break;
            case 10:
                text.setText("Si ama ang mama");
                sound = MediaPlayer.create(ma_ma_screen.this, R.raw.new_si_ama_ang_mama);
                break;
            case 11:
                text.setText("Ang ama ay si Oma");
                sound = MediaPlayer.create(ma_ma_screen.this, R.raw.new_ang_ama_ay_si_oma);
                break;
            case 12:
                text.setText("Ang Ama");
                sound = MediaPlayer.create(ma_ma_screen.this, R.raw.new_ang_ama);
                break;
            case 13:
                text.setText("Ang ama ay si Uma");
                sound = MediaPlayer.create(ma_ma_screen.this, R.raw.new_ang_ama_ay_si_uma);
                break;
            case 14:
                text.setText("Si ama ay mama");
                sound = MediaPlayer.create(ma_ma_screen.this, R.raw.new_si_ama_ay_mama);
                break;
        }
    }
    ...
    private void say_question(final int counter) {
        ...
        sound = MediaPlayer.create(ma_ma_screen.this, R.raw.ba);
        sound.release();
        sound = MediaPlayer.create(ma_ma_screen.this, R.raw.makinig_at_basahin_ng_mabuti_ang_mga_titik_gamit_ang_mikropono);
        sound.start();
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int i) {
                ...
                if (bool_mic_case_down) {
                    bool_mic_case_down = false;
                    sound_mali = MediaPlayer.create(ma_ma_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                } else {
                    if (i == 1 || i == 2 || i == 3 || i == 4) {
                        sound_mali = MediaPlayer.create(ma_ma_screen.this, R.raw.kailangan_kumunekta_sa_internet1);
                    } else if (i == 6) {
                        sound_mali = MediaPlayer.create(ma_ma_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                    } else if (i == 7 || i == 5 || i == 9) {
                        sound_mali = speak_tama.speak_mali(ma_ma_screen.this);
                    } else {
                        sound_mali = MediaPlayer.create(ma_ma_screen.this, R.raw.pakiulit_ng_iyong_sinabi1);
                    }
                }
            ...
            public void onResults(Bundle bundle) {
                ...
                if (speech_method.speech(text_text, speech)) {
                    sound = speak_tama.speak_tama(ma_ma_screen.this);
                    counter++;
                    tama = true;
                    ...
                    sound.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            ...
                            if (counter == 15) {
                                ...
                                Intent go = new Intent(ma_ma_screen.this, overview_screen.class);
                                go.putExtra("SIMULA", simula)
                                        .putExtra("WAKAS", wakas)
                                        .putExtra("ORAS", oras)
                                        .putExtra("DATE", date_t)
                                        .putExtra("TITLE", "Marungko Approach: Ma-ma");
                                startActivity(go);
                                Animatoo.animateShrink(ma_ma_screen.this);
                                finish();
                            } else {
                                check.setVisibility(View.INVISIBLE);
                                question(counter);
    ...
    private void initialise() {
        ...
        if (bgm == null) {
            bgm = MediaPlayer.create(ma_ma_screen.this, R.raw.bgm1);
            bgm.setVolume(.1f, .1f);
            bgm.setLooping(true);
            bgm.start();
        }
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                speak_tama.tap_back(ma_ma_screen.this);
                startActivity(new Intent(ma_ma_screen.this, CategoryScreen.class));
                Animatoo.animateSlideRight(ma_ma_screen.this);
                finish();
            }
        });
    ...
    private void checkPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (!(ContextCompat.checkSelfPermission(ma_ma_screen.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED)) {
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Sige", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ActivityCompat.requestPermissions(ma_ma_screen.this, new String[]{Manifest.permission.RECORD_AUDIO}, REQUEST_PERMISSION_RECORD_AUDIO);
                                }
                            })
