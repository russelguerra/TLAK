...
public class hayop_screen extends AppCompatActivity {
    private static final String TAG = "hayop_screen";
    ...
    private String string1 = "aso", string2 = "pusa", string3 = "baboy",
            string4 = "palaka", string5 = "bibe", string6 = "manok",
            string7 = "ibon", string8 = "kabayo", string9 = "kambing",
            string10 = "kalabaw";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hayop_screen);
        initialise();
        image_views();
        mics();

        sound = MediaPlayer.create(hayop_screen.this, R.raw.ba);
        sound_tama = MediaPlayer.create(hayop_screen.this, R.raw.iba_pang_sagot1);

        if (bgm == null) {
            bgm = MediaPlayer.create(hayop_screen.this, R.raw.bgm6);
            bgm.setVolume(.1f, .1f);
            bgm.setLooping(true);
            bgm.start();
        }
    ...
    private void show_dialog() {
        if (tap_count > 2 && (tap_count % 2 == 0)) {
            ...
            sound = MediaPlayer.create(hayop_screen.this, R.raw.sabihin_ang_salitang_narinig_gamit_ang_mikropono);
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int i) {
                ...
                if (bool_mic_case_down) {
                    ...
                    sound_tama = MediaPlayer.create(hayop_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                } else {
                    if (i == 1 || i == 2 || i == 3 || i == 4) {
                        sound_tama = MediaPlayer.create(hayop_screen.this, R.raw.kailangan_kumunekta_sa_internet1);
                    } else if (i == 6) {
                        sound_tama = MediaPlayer.create(hayop_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                    } else if (i == 7) {
                        sound_tama = speak_tama.speak_mali(hayop_screen.this);
                    } else if (i == 5) {
                        sound_tama = speak_tama.speak_mali(hayop_screen.this);
                        ...
                        sound_tama = MediaPlayer.create(hayop_screen.this, R.raw.pakiulit_ng_iyong_sinabi1);
                    }
                }
            ...
            public void onResults(Bundle bundle) {
                ...
                if (word.equals(string1) && speech.equals(string1)) {
                    sound_tama = speak_tama.speak_tama(hayop_screen.this);
                    bool1 = true;
                    counter_check++;
                    tutorial = false;
                    ...
                    bool4 = true;
                    counter_check++;
                } else if (word.equals(string5) && (speech.equals(string5)) || speech.equals("bebe") || speech.equals("db") || speech.equals("baby")) {
                    sound_tama = speak_tama.speak_tama(hayop_screen.this);
                    bool5 = true;
                    counter_check++;
                ...
                sound_tama.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mediaPlayer) {
                        ...
                        if (counter_check == 10) {
                            ...
                            Intent go = new Intent(hayop_screen.this, overview_screen.class);
                            go.putExtra("SIMULA", simula)
                                    .putExtra("WAKAS", wakas)
                                    .putExtra("ORAS", oras)
                                    .putExtra("DATE", date_t)
                                    .putExtra("TITLE", "Mga Hayop");
                            startActivity(go);
                            Animatoo.animateShrink(hayop_screen.this);
                            finish();
                        }
                    }
                });
    ...
    private void tunog(int tunog) {
        ...
        sound = MediaPlayer.create(hayop_screen.this, tunog);
        sound.start();
        sound.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
    ...
    private void initialise() {
        ...
        Glide.with(this).load(R.drawable.aso).into(image1_2);
        ...
        Glide.with(this).load(R.drawable.aso).into(image1);
        Glide.with(this).load(R.drawable.pusa).into(image2);
        Glide.with(this).load(R.drawable.baboy).into(image3);
        Glide.with(this).load(R.drawable.palaka).into(image4);
        Glide.with(this).load(R.drawable.bibe).into(image5);
        Glide.with(this).load(R.drawable.manok).into(image6);
        Glide.with(this).load(R.drawable.ibon).into(image7);
        Glide.with(this).load(R.drawable.kabayo).into(image8);
        Glide.with(this).load(R.drawable.kambing).into(image9);
        Glide.with(this).load(R.drawable.kalabaw).into(image10);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                speak_tama.tap_back(hayop_screen.this);
                startActivity(new Intent(hayop_screen.this, CategoryScreen.class));
                Animatoo.animateSlideRight(hayop_screen.this);
                finish();
            }
        });
    ...
    private void checkPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (!(ContextCompat.checkSelfPermission(hayop_screen.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED)) {
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Sige", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ActivityCompat.requestPermissions(hayop_screen.this, new String[]{Manifest.permission.RECORD_AUDIO}, REQUEST_PERMISSION_RECORD_AUDIO);
                                }
                            })
