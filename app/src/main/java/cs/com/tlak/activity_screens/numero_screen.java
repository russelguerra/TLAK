...
public class numero_screen extends AppCompatActivity {
    private static final String TAG = "numero_screen";
    ...
    private String string1 = "isa", string2 = "dalawa", string3 = "tatlo",
            string4 = "apat", string5 = "lima", string6 = "anim",
            string7 = "pito", string8 = "walo", string9 = "siyam",
            string10 = "sampu";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numero_screen);
        initialise();
        image_views();
        mics();

        sound = MediaPlayer.create(numero_screen.this, R.raw.ba);
        sound_tama = MediaPlayer.create(numero_screen.this, R.raw.ba);

        if (bgm == null) {
            bgm = MediaPlayer.create(numero_screen.this, R.raw.bgm4);
            bgm.setVolume(.1f, .1f);
            bgm.setLooping(true);
            bgm.start();
        }
    ...
    private void show_dialog() {
        if (tap_count > 2 && (tap_count % 2 == 0)) {
            ...
            sound = MediaPlayer.create(numero_screen.this, R.raw.sabihin_ang_salitang_narinig_gamit_ang_mikropono);
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int i) {
                ...
                if (bool_mic_case_down) {
                    ...
                    sound_tama = MediaPlayer.create(numero_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                } else {
                    if (i == 1 || i == 2 || i == 3 || i == 4) {
                        sound_tama = MediaPlayer.create(numero_screen.this, R.raw.kailangan_kumunekta_sa_internet1);
                    } else if (i == 6) {
                        sound_tama = MediaPlayer.create(numero_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                    } else if (i == 7) {
                        sound_tama = speak_tama.speak_mali(numero_screen.this);
                    } else if (i == 5) {
                        sound_tama = speak_tama.speak_mali(numero_screen.this);
                        ...
                        sound_tama = MediaPlayer.create(numero_screen.this, R.raw.pakiulit_ng_iyong_sinabi1);
                    }
                }
            ...
            public void onResults(Bundle bundle) {
                ...
                if (word.equals(string1) && speech.equals(string1)) {
                    sound_tama = speak_tama.speak_tama(numero_screen.this);
                    bool1 = true;
                    counter_check++;
                    tutorial = false;
                    ...
                    bool5 = true;
                    counter_check++;
                } else if (word.equals(string6) && (speech.equals(string6) || speech.equals("anime") || speech.equals("i mean") || speech.equals("annum"))) {
                    sound_tama = speak_tama.speak_tama(numero_screen.this);
                    bool6 = true;
                    counter_check++;
                    ...
                    bool7 = true;
                    counter_check++;
                } else if (word.equals(string8) && speech.equals(string8)) {
                    sound_tama = speak_tama.speak_tama(numero_screen.this);
                    bool8 = true;
                    counter_check++;
                } else if (word.equals(string9) && (speech.equals(string9) || speech.equals("sham") || speech.equals("jam") || speech.equals("shawn"))) {
                    sound_tama = speak_tama.speak_tama(numero_screen.this);
                    bool9 = true;
                    counter_check++;
                } else if (word.equals(string10) && (speech.equals(string10) || speech.equals("sampo"))) {
                    sound_tama = speak_tama.speak_tama(numero_screen.this);
                    bool10 = true;
                    counter_check++;
                } else {
                ...
                sound_tama.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mediaPlayer) {
                        ...
                        if (counter_check == 10) {
                            ...
                            Intent go = new Intent(numero_screen.this, overview_screen.class);
                            go.putExtra("SIMULA", simula)
                                    .putExtra("WAKAS", wakas)
                                    .putExtra("ORAS", oras)
                                    .putExtra("DATE", date_t)
                                    .putExtra("TITLE", "Mga Numero");
                            startActivity(go);
                            Animatoo.animateShrink(numero_screen.this);
                            finish();
                        }
                    }
                });
    ...
    private void tunog(int tunog) {
        ...
        sound = MediaPlayer.create(numero_screen.this, tunog);
        sound.start();
        sound.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
    ...
    private void initialise() {
        ...
        Glide.with(this).load(R.drawable.one).into(image1_2);
        ...
        Glide.with(this).load(R.drawable.bg_gif3).into(background);

        Glide.with(this).load(R.drawable.one).into(image1);
        Glide.with(this).load(R.drawable.two).into(image2);
        Glide.with(this).load(R.drawable.three).into(image3);
        Glide.with(this).load(R.drawable.four).into(image4);
        Glide.with(this).load(R.drawable.five).into(image5);
        Glide.with(this).load(R.drawable.six).into(image6);
        Glide.with(this).load(R.drawable.seven).into(image7);
        Glide.with(this).load(R.drawable.eight).into(image8);
        Glide.with(this).load(R.drawable.nine).into(image9);
        Glide.with(this).load(R.drawable.ten).into(image10);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                speak_tama.tap_back(numero_screen.this);
                startActivity(new Intent(numero_screen.this, CategoryScreen.class));
                Animatoo.animateSlideRight(numero_screen.this);
                finish();
            }
        });
    ...
    private void checkPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (!(ContextCompat.checkSelfPermission(numero_screen.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED)) {
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Sige", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ActivityCompat.requestPermissions(numero_screen.this, new String[]{Manifest.permission.RECORD_AUDIO}, REQUEST_PERMISSION_RECORD_AUDIO);
                                }
                            })
