...
public class transportasyon_screen extends AppCompatActivity {
    private static final String TAG = "transportasyon_screen";
    ...
    private String string1 = "kotse", string2 = "bisikleta", string3 = "trak",
            string4 = "eroplano", string5 = "helikopter", string6 = "tren",
            string7 = "barko", string8 = "dyip", string9 = "motorsiklo",
            string10 = "bus";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transportasyon_screen);
        initialise();
        image_views();
        mics();

        sound = MediaPlayer.create(transportasyon_screen.this, R.raw.ba);
        sound_tama = MediaPlayer.create(transportasyon_screen.this, R.raw.kids_yay);

        if (bgm == null) {
            bgm = MediaPlayer.create(transportasyon_screen.this, R.raw.bgm8);
            bgm.setVolume(.1f, .1f);
            bgm.setLooping(true);
            bgm.start();
        }
    ...
    private void show_dialog() {
        if (tap_count > 2 && (tap_count % 2 == 0)) {
            ...
            sound = MediaPlayer.create(transportasyon_screen.this, R.raw.sabihin_ang_salitang_narinig_gamit_ang_mikropono);
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int i) {
                ...
                if (bool_mic_case_down) {
                    ...
                    sound_tama = MediaPlayer.create(transportasyon_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                } else {
                    if (i == 1 || i == 2 || i == 3 || i == 4) {
                        sound_tama = MediaPlayer.create(transportasyon_screen.this, R.raw.kailangan_kumunekta_sa_internet1);
                    } else if (i == 6) {
                        sound_tama = MediaPlayer.create(transportasyon_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                    } else if (i == 7) {
                        sound_tama = speak_tama.speak_mali(transportasyon_screen.this);
                    } else if (i == 5) {
                        sound_tama = speak_tama.speak_mali(transportasyon_screen.this);
                        ...
                        sound_tama = MediaPlayer.create(transportasyon_screen.this, R.raw.pakiulit_ng_iyong_sinabi1);
                    }
                }
            ...
            public void onResults(Bundle bundle) {
                ...
                if (word.equals(string1) && speech.equals(string1)) {
                    sound_tama = speak_tama.speak_tama(transportasyon_screen.this);
                    bool1 = true;
                    counter_check++;
                    tutorial = false;
                    ...
                    bool2 = true;
                    counter_check++;
                } else if (word.equals(string3) && (speech.equals(string3) || speech.equals("truck")) || speech.equals("track")) {
                    sound_tama = speak_tama.speak_tama(transportasyon_screen.this);
                    bool3 = true;
                    counter_check++;
                    ...
                    bool4 = true;
                    counter_check++;
                } else if (word.equals(string5) && (speech.equals(string5)) || speech.equals("helicopter")) {
                    sound_tama = speak_tama.speak_tama(transportasyon_screen.this);
                    bool5 = true;
                    counter_check++;
                } else if (word.equals(string6) && speech.equals(string6) || speech.equals("trend")) {
                    sound_tama = speak_tama.speak_tama(transportasyon_screen.this);
                    bool6 = true;
                    counter_check++;
                } else if (word.equals(string7) && speech.equals(string7)) {
                    sound_tama = speak_tama.speak_tama(transportasyon_screen.this);
                    bool7 = true;
                    counter_check++;
                } else if (word.equals(string8) && (speech.equals(string8)) || speech.equals("jeep")) {
                    sound_tama = speak_tama.speak_tama(transportasyon_screen.this);
                    bool8 = true;
                    counter_check++;
                } else if (word.equals(string9) && (speech.equals(string9)) || speech.equals("motor siklo") || speech.equals("motorcycle")) {
                    sound_tama = speak_tama.speak_tama(transportasyon_screen.this);
                    bool9 = true;
                    counter_check++;
                } else if (word.equals(string10) && (speech.equals(string10) || speech.equals("booth"))) {
                    sound_tama = speak_tama.speak_tama(transportasyon_screen.this);
                    bool10 = true;
                    counter_check++;
                } else {
                ...
                sound_tama.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mediaPlayer) {
                        ...
                        if (counter_check == 10) {
                            ...
                            Intent go = new Intent(transportasyon_screen.this, overview_screen.class);
                            go.putExtra("SIMULA", simula)
                                    .putExtra("WAKAS", wakas)
                                    .putExtra("ORAS", oras)
                                    .putExtra("DATE", date_t)
                                    .putExtra("TITLE", "Mga Transportasyon");
                            startActivity(go);
                            Animatoo.animateShrink(transportasyon_screen.this);
                            finish();
                        }
                    }
                });
    ...
    private void on_motion_down(ImageView image_view) {
        ObjectAnimator scaleDownX = ObjectAnimator.ofFloat(image_view,
                "scaleX", 0.8f);
        ObjectAnimator scaleDownY = ObjectAnimator.ofFloat(image_view,
                "scaleY", 0.8f);
    ...
    private void on_motion_up(ImageView image_view) {
    ...
    private void speak_dalawa() {
        ...
        switch (x_tunog) {
            case 1:
                tunog = R.raw.bisikleta1;
                break;
            case 2:
                tunog = R.raw.bisikleta2;
                break;
        }
        tunog(tunog);
    }
    ...
    private void speak_apat() {
        ...
        switch (x_tunog) {
            case 1:
                tunog = R.raw.eroplano1;
                break;
            case 2:
                tunog = R.raw.eroplano2;
                break;
        }
        tunog(tunog);
    }
    ...
    private void speak_lima() {
        ...
        switch (x_tunog) {
            case 1:
                tunog = R.raw.helikopter1;
                break;
            case 2:
                tunog = R.raw.helikopter2;
                break;
        }
        tunog(tunog);
    }
    ...
    private void speak_siyam() {
        ...
        switch (x_tunog) {
            case 1:
                tunog = R.raw.motorsiklo1;
                break;
            case 2:
                tunog = R.raw.motorsiklo2;
                break;
        }
        tunog(tunog);
    }
    ...
    private void tunog(int tunog) {
        ...
        sound = MediaPlayer.create(transportasyon_screen.this, tunog);
        sound.start();
        sound.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
    ...
    private void initialise() {
        ...
        image1_2 = findViewById(R.id.image1_2);
        tap1_2 = findViewById(R.id.tap1_2);
        tap2_2 = findViewById(R.id.tap2_2);
        mic1_2 = findViewById(R.id.mic1_2);

        Glide.with(this).load(R.drawable.kotse).into(image1_2);
        ...
        Glide.with(this).load(R.drawable.kotse).into(image1);
        Glide.with(this).load(R.drawable.bisikleta).into(image2);
        Glide.with(this).load(R.drawable.trak).into(image3);
        Glide.with(this).load(R.drawable.eroplano).into(image4);
        Glide.with(this).load(R.drawable.helikopter).into(image5);
        Glide.with(this).load(R.drawable.tren).into(image6);
        Glide.with(this).load(R.drawable.barko).into(image7);
        Glide.with(this).load(R.drawable.dyip).into(image8);
        Glide.with(this).load(R.drawable.motorsiklo).into(image9);
        Glide.with(this).load(R.drawable.bus).into(image10);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                speak_tama.tap_back(transportasyon_screen.this);
                startActivity(new Intent(transportasyon_screen.this, CategoryScreen.class));
                Animatoo.animateSlideRight(transportasyon_screen.this);
                finish();
            }
        });
    ...
    private void checkPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (!(ContextCompat.checkSelfPermission(transportasyon_screen.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED)) {
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Sige", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ActivityCompat.requestPermissions(transportasyon_screen.this, new String[]{Manifest.permission.RECORD_AUDIO}, REQUEST_PERMISSION_RECORD_AUDIO);
                                }
                            })
