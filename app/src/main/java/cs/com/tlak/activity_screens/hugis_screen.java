...
public class hugis_screen extends AppCompatActivity {
    private static final String TAG = "hugis_screen";
    ...
    private ImageView back, background, image1, image2, image4, image3,
            image5, image6, image7, image8, image9;
    private ImageView mic1, mic2, mic4, mic3,
            mic5, mic6, mic7, mic8, mic9;
    private ImageView check1, check2, check3, check4, check5, check6, check7, check8, check9;
    private ImageView tap1, tap2, tap3, tap4, tap5, tap6, tap7, tap8, tap9;

    private String string1 = "bilog", string2 = "parisukat", string4 = "parihaba", string3 = "tatsulok",
            string5 = "oblong", string6 = "bituin", string7 = "diyamante", string8 = "pentagono", string9 = "heksagono";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hugis_screen);

        initialise();
        image_views();
        mics();

        sound = MediaPlayer.create(hugis_screen.this, R.raw.ba);
        sound_tama = MediaPlayer.create(hugis_screen.this, R.raw.kids_yay);

        if (bgm == null) {
            bgm = MediaPlayer.create(hugis_screen.this, R.raw.bgm5);
            bgm.setVolume(.1f, .1f);
            bgm.setLooping(true);
            bgm.start();
        }
    ...
    private void show_dialog() {
        if (tap_count > 2 && (tap_count % 2 == 0)) {
            ...
            sound = MediaPlayer.create(hugis_screen.this, R.raw.sabihin_ang_salitang_narinig_gamit_ang_mikropono);
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int i) {
                ...
                if (bool_mic_case_down) {
                    ...
                    sound_tama = MediaPlayer.create(hugis_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                } else {
                    if (i == 1 || i == 2 || i == 3 || i == 4) {
                        sound_tama = MediaPlayer.create(hugis_screen.this, R.raw.kailangan_kumunekta_sa_internet1);
                    } else if (i == 6) {
                        sound_tama = MediaPlayer.create(hugis_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                    } else if (i == 7) {
                        sound_tama = speak_tama.speak_mali(hugis_screen.this);
                    } else if (i == 5) {
                        sound_tama = speak_tama.speak_mali(hugis_screen.this);
                        ...
                        sound_tama = MediaPlayer.create(hugis_screen.this, R.raw.pakiulit_ng_iyong_sinabi1);
                    }
                }
            ...
            public void onResults(Bundle bundle) {
                ...
                if (word.equals(string1) && speech.equals(string1)) {
                    sound_tama = speak_tama.speak_tama(hugis_screen.this);
                    bool1 = true;
                    counter_check++;
                    tutorial = false;
                } else if (word.equals(string2) && speech.equals(string2)) {
                    sound_tama = speak_tama.speak_tama(hugis_screen.this);
                    bool2 = true;
                    counter_check++;
                } else if (word.equals(string3) && speech.equals(string3)) {
                    sound_tama = speak_tama.speak_tama(hugis_screen.this);
                    bool3 = true;
                    counter_check++;
                } else if (word.equals(string4) && speech.equals(string4)) {
                    sound_tama = speak_tama.speak_tama(hugis_screen.this);
                    bool4 = true;
                    counter_check++;
                } else if (word.equals(string5) && speech.equals(string5)) {
                    sound_tama = speak_tama.speak_tama(hugis_screen.this);
                    bool5 = true;
                    counter_check++;
                } else if (word.equals(string6) && (speech.equals(string6) || speech.equals("between"))) {
                    sound_tama = speak_tama.speak_tama(hugis_screen.this);
                    bool6 = true;
                    counter_check++;
                } else if (word.equals(string7) && (speech.equals(string7) || speech.equals("jamante"))) {
                    sound_tama = speak_tama.speak_tama(hugis_screen.this);
                    bool7 = true;
                    counter_check++;
                } else if (word.equals(string8) && (speech.equals(string8)) || speech.equals("pentagonal")) {
                    sound_tama = speak_tama.speak_tama(hugis_screen.this);
                    bool8 = true;
                    counter_check++;
                } else if (word.equals(string9) && (speech.equals(string9) || speech.equals("hexagonal"))) {
                    sound_tama = speak_tama.speak_tama(hugis_screen.this);
                    bool9 = true;
                    counter_check++;
                } else {
                ...
                sound_tama.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mediaPlayer) {
                        ...
                        if (counter_check == 9) {
                            ...
                            Intent go = new Intent(hugis_screen.this, overview_screen.class);
                            go.putExtra("SIMULA", simula)
                                    .putExtra("WAKAS", wakas)
                                    .putExtra("ORAS", oras)
                                    .putExtra("DATE", date_t)
                                    .putExtra("TITLE", "Mga Hugis");
                            startActivity(go);
                            Animatoo.animateShrink(hugis_screen.this);
                            finish();
                        }
                    }
                });
    ...
    private void on_motion_down(ImageView image) {
        ObjectAnimator scaleDownX = ObjectAnimator.ofFloat(image,
                "scaleX", 0.8f);
        ObjectAnimator scaleDownY = ObjectAnimator.ofFloat(image,
                "scaleY", 0.8f);
    ...
    private void on_motion_up(ImageView image) {
    ...
    private void speak_dalawa() {
        ...
        if (x_tunog == 1) {
            tunog = R.raw.parisukat1;
        }
        if (x_tunog == 2) {
            tunog = R.raw.parisukat2;
        }
        tunog(tunog);
    }
    ...
    private void speak_walo() {
        ...
        switch (x_tunog) {
            case 1:
                tunog = R.raw.pentagono1;
                break;
            case 2:
                tunog = R.raw.pentagono2;
                break;
        }
        tunog(tunog);
    }
    ...
    private void tunog(int tunog) {
        ...
        sound = MediaPlayer.create(hugis_screen.this, tunog);
        sound.start();
        sound.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
    ...
    private void initialise() {
        ...
        image1 = findViewById(R.id.bilog);
        image2 = findViewById(R.id.parisukat);
        image4 = findViewById(R.id.parihaba);
        image3 = findViewById(R.id.tatsulok);
        image5 = findViewById(R.id.oblong);
        image7 = findViewById(R.id.diyamante);
        image6 = findViewById(R.id.bituin);
        image8 = findViewById(R.id.pentagono);
        image9 = findViewById(R.id.heksagono);

        mic1 = findViewById(R.id.mic_bilog);
        mic4 = findViewById(R.id.mic_parihaba);
        mic2 = findViewById(R.id.mic_parisukat);
        mic3 = findViewById(R.id.mic_tatsulok);
        mic5 = findViewById(R.id.mic_oblong);
        mic6 = findViewById(R.id.mic_bituin);
        mic7 = findViewById(R.id.mic_diyamante);
        mic8 = findViewById(R.id.mic_pentagono);
        mic9 = findViewById(R.id.mic_heksagono);
        ...
        image1_2 = findViewById(R.id.bilog_2);
        tap1_2 = findViewById(R.id.tap1_2);
        tap2_2 = findViewById(R.id.tap2_2);
        mic1_2 = findViewById(R.id.mic_bilog_2);

        Glide.with(this).load(R.drawable.bilog).into(image1_2);
        ...
        Glide.with(this).load(R.drawable.bilog).into(image1);
        Glide.with(this).load(R.drawable.parisukat).into(image2);
        Glide.with(this).load(R.drawable.parihaba).into(image4);
        Glide.with(this).load(R.drawable.tatsulok).into(image3);
        Glide.with(this).load(R.drawable.oblong).into(image5);
        Glide.with(this).load(R.drawable.diyamante).into(image7);
        Glide.with(this).load(R.drawable.bituin).into(image6);
        Glide.with(this).load(R.drawable.pentagono).into(image8);
        Glide.with(this).load(R.drawable.heksagono).into(image9);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                speak_tama.tap_back(hugis_screen.this);
                startActivity(new Intent(hugis_screen.this, CategoryScreen.class));
                Animatoo.animateSlideRight(hugis_screen.this);
                finish();
            }
        });
    ...
    private void checkPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (!(ContextCompat.checkSelfPermission(hugis_screen.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED)) {
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Sige", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ActivityCompat.requestPermissions(hugis_screen.this, new String[]{Manifest.permission.RECORD_AUDIO}, REQUEST_PERMISSION_RECORD_AUDIO);
                                }
                            })
