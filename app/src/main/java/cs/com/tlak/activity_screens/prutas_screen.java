...
public class prutas_screen extends AppCompatActivity {
    private static final String TAG = "prutas_screen";
    ...
    private String string1 = "saging", string2 = "atis", string3 = "mangga",
            string4 = "papaya", string5 = "santol", string6 = "rambutan",
            string7 = "pakwan", string8 = "kahel", string9 = "langka",
            string10 = "guyabano";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prutas_screen);
        initialise();
        image_views();
        mics();

        sound = MediaPlayer.create(prutas_screen.this, R.raw.ba);
        sound_tama = MediaPlayer.create(prutas_screen.this, R.raw.iba_pang_sagot1);

        if (bgm == null) {
            bgm = MediaPlayer.create(prutas_screen.this, R.raw.bgm7);
            bgm.setVolume(.1f, .1f);
            bgm.setLooping(true);
            bgm.start();
        }
    ...
    private void show_dialog() {
        if (tap_count > 2 && (tap_count % 2 == 0)) {
            ...
            sound = MediaPlayer.create(prutas_screen.this, R.raw.sabihin_ang_salitang_narinig_gamit_ang_mikropono);
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int i) {
                ...
                if (bool_mic_case_down) {
                    ...
                    sound_tama = MediaPlayer.create(prutas_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                } else {
                    if (i == 1 || i == 2 || i == 3 || i == 4) {
                        sound_tama = MediaPlayer.create(prutas_screen.this, R.raw.kailangan_kumunekta_sa_internet1);
                    } else if (i == 6) {
                        sound_tama = MediaPlayer.create(prutas_screen.this, R.raw.panatilihing_pindot_ang_mikropono1);
                    } else if (i == 7) {
                        sound_tama = speak_tama.speak_mali(prutas_screen.this);
                    } else if (i == 5) {
                        sound_tama = speak_tama.speak_mali(prutas_screen.this);
                        ...
                        sound_tama = MediaPlayer.create(prutas_screen.this, R.raw.pakiulit_ng_iyong_sinabi1);
                    }
                }
            ...
            public void onResults(Bundle bundle) {
                ...
                if (word.equals(string1) && (speech.equals(string1) || speech.equals("sagging"))) {
                    sound_tama = speak_tama.speak_tama(prutas_screen.this);
                    bool1 = true;
                    counter_check++;
                    tutorial = false;
                    ...
                    bool2 = true;
                    counter_check++;
                } else if (word.equals(string3) && (speech.equals(string3)) || speech.equals("manga")) {
                    sound_tama =  speak_tama.speak_tama(prutas_screen.this);
                    bool3 = true;
                    counter_check++;
                    ...
                    bool5 = true;
                    counter_check++;
                } else if (word.equals(string6) && (speech.equals(string6))) {
                    sound_tama =  speak_tama.speak_tama(prutas_screen.this);
                    bool6 = true;
                    counter_check++;
                    ...
                    bool8 = true;
                    counter_check++;
                } else if (word.equals(string9) && (speech.equals(string9))) {
                    sound_tama =  speak_tama.speak_tama(prutas_screen.this);
                    bool9 = true;
                    counter_check++;
                } else if (word.equals(string10) && (speech.equals(string10))) {
                    sound_tama =  speak_tama.speak_tama(prutas_screen.this);
                    bool10 = true;
                    counter_check++;
                } else {
                ...
                sound_tama.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mediaPlayer) {
                        ...
                        if (counter_check == 10) {
                            ...
                            Intent go = new Intent(prutas_screen.this, overview_screen.class);
                            go.putExtra("SIMULA", simula)
                                    .putExtra("WAKAS", wakas)
                                    .putExtra("ORAS", oras)
                                    .putExtra("DATE", date_t)
                                    .putExtra("TITLE", "Mga Numbero");
                            startActivity(go);
                            Animatoo.animateShrink(prutas_screen.this);
                            finish();
                        }
                    }
                });
    ...
    private void tunog(int tunog) {
        ...
        sound = MediaPlayer.create(prutas_screen.this, tunog);
        sound.start();
        sound.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
    ...
    private void initialise() {
        ...
        Glide.with(this).load(R.drawable.saging).into(image1_2);
        ...
        Glide.with(this).load(R.drawable.saging).into(image1);
        Glide.with(this).load(R.drawable.atis).into(image2);
        Glide.with(this).load(R.drawable.mangga).into(image3);
        Glide.with(this).load(R.drawable.papaya).into(image4);
        Glide.with(this).load(R.drawable.santol).into(image5);
        Glide.with(this).load(R.drawable.rambutan).into(image6);
        Glide.with(this).load(R.drawable.pakwan).into(image7);
        Glide.with(this).load(R.drawable.kahel).into(image8);
        Glide.with(this).load(R.drawable.langka).into(image9);
        Glide.with(this).load(R.drawable.guyabano).into(image10);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                speak_tama.tap_back(prutas_screen.this);
                startActivity(new Intent(prutas_screen.this, CategoryScreen.class));
                Animatoo.animateSlideRight(prutas_screen.this);
                finish();
            }
        });
    ...
    private void checkPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (!(ContextCompat.checkSelfPermission(prutas_screen.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED)) {
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Sige", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ActivityCompat.requestPermissions(prutas_screen.this, new String[]{Manifest.permission.RECORD_AUDIO}, REQUEST_PERMISSION_RECORD_AUDIO);
                                }
                            })
